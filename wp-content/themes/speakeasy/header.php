...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$speakeasy_description = get_bloginfo( 'description', 'display' );
			if ( $speakeasy_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $speakeasy_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
